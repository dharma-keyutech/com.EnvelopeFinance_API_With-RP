...
public class GET_credit_card_details {
	private static final Logger logger = LogManager.getLogger(GET_credit_card_details.class);
	...
	public void getcreditcarddetails() throws IOException {
		...
		// passing the payload to perticular end point with help of response body

		Response response_body = request.body(payload).get("/credit_card_details");
