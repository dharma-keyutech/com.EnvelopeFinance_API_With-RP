...
public class GET_yodlee_user_token {
	
	private static final Logger logger = LogManager.getLogger(GET_yodlee_user_token.class);
...
// Passing  Headders 
		...
		Response response_body = request.body(payload).post("/get_yodlee_user_token");
